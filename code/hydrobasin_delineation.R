##Hydrobasin delineation -  benthic invertebrate 
...
##get tile ID of each tile that is part of the benthic invert dataset
tile_id <- get_tile_id(data = bi_site_df,
                       lon = "Longitude_X",  lat = "Latitude_Y")

reg_unit_df <- get_regional_unit_id(data = bi_site_df,
                                    lon = "Longitude_X",  lat = "Latitude_Y")
...
write.csv(data.frame(x = 1), "/Volumes/LaCie/test_write.csv")
